                ...
                {/* BOTON CERRAR EDITAR CLIENTE */}
                    ...
                    <form onSubmit={terminarEdicion}>
                        <div className="input-group mb-3">
                            ...
                            <input type="text" className="form-control" placeholder="Nuevo nombre" aria-label="Username" aria-describedby="basic-addon1" defaultValue={clienteSeleccionado.nombre} autoFocus required onChange={setNombreEditar}/>
                        </div>

                        <div className="input-group mb-3">
                            <input type="number" className="form-control" placeholder="Nueva identificacion" aria-label="Recipient's username" aria-describedby="basic-addon2" defaultValue={clienteSeleccionado.identificacion} required onChange={setIdentificacionEditar}/>
                        ...
                        <div className="input-group mb-3">
                            ...
                            <input type="number" className="form-control" placeholder="Nuevo telefono" aria-label="Username" aria-describedby="basic-addon1" defaultValue={clienteSeleccionado.telefono} required onChange={setTelefonoEditar}/>
                        </div>

                        <div className="input-group mb-3">
                            <input type="text" className="form-control" placeholder="Nueva direccion" aria-label="Recipient's username" aria-describedby="basic-addon2" defaultValue={clienteSeleccionado.direccion} required onChange={setDireccionEditar}/>
                            <div className="input-group-append">
                        ...
                        <div className="input-group mb-3">
                            ...
                            <input type="text" className="form-control" placeholder="Nueva ciudad" aria-label="Username" aria-describedby="basic-addon1" defaultValue={clienteSeleccionado.ciudad} required onChange={setCiudadEditar}/>
                        </div>
